...
<head>
    ...
    <title>ADMIN |Sopore Pet House</title>
            ...
            <div class="container">
                <div class="navbar-header">
                    <button type="button" class="navbar-toggle" data-toggle="collapse" data-target=".navbar-collapse">
                     ...
                     <a href="index.php"><                    <img src="images/logo.png"  width="30% " height="50px" />
                  </a><i class="wow fadeInDown" style="margin-top:-2%; color:#FFF;"></i></a>
                </div>
